...
from llava.train.train import load_previous_task_LoRA, load_model_from_previous_task
...
def eval_model(args):
    ...
    # if model_path is not None and not isinstance(model_path, list):
    #     model_path  = ast.literal_eval(model_path)
    # model_path.append("./checkpoints/MLLM-DCL/LLaVA-1.5/LoRA/Task2_llava_lora")
    model_name = get_model_name_from_path(model_path[-1])
